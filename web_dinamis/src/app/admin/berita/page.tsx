  ...
  return (
    <div>
      <div className="admin-page-header">
        <div>
          <div className="admin-page-title">Kelola Tren Fashion</div>
            ...
            {berita.length === 0 ? (
              <tr>
                <td colSpan={5} style={{ textAlign: "center", padding: "48px", color: "#94a3b8" }}>
                  Belum ada tren fashion. Klik &quot;Tambah Tren Baru&quot; untuk memulai.
                </td>
              </tr>
            ) : berita.map((item: any) => (
              <tr key={item.id}>
